...
## Project Structure
    ...
    ├── samuel_test_cancel__30601  # Django project configurations
...
1. Clone this repo and `cd samuel_test_cancel__30601`
...
2. Clone this repo and `cd samuel_test_cancel__30601`
